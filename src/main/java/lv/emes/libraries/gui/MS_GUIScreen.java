...
/**
 * There is infinite count of different screen types that GUI can show.
 * This class represent common attributes for them all platform independently.
 * <p>Public methods:
 * <ul>
 * <li>show</li>
 * <li>close</li>
 ...
 * @version 1.0.
 */
public abstract class MS_GUIScreen {
     ...
     *
     * @param type custom type number or one of this class statically defined types. If 0 then <b>MS_GUIScreen.UNKNOWN_SCREEN</b>.
     */
    public MS_GUIScreen(int type) {
        this.type = type;
    }
