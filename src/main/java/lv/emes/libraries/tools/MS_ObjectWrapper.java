 ...
 * @version 1.0.
 */
public interface MS_ObjectWrapper<T> {

    /**
     * Fills all other instance member values with the ones from wrapped object and saves reference to wrapped object.
     * This method has an opposite effect of {@link MS_ObjectWrapper#unwrap()} method.
     * <p><u>For callers</u>: as it needs first to create new instance of wrapper <b>MS_ObjectWrapper</b>, that is recommended to use
     * {@link MS_ObjectWrapperHelper#wrap(Object, Class)} method to get wrapper created and initialized with data from
     * wrapped object instead of creating new instance of <b>MS_ObjectWrapper</b> and manually calling this method.
     ...
     * This method has an opposite effect of {@link MS_ObjectWrapper#wrap(Object)} method.
     * <p><u>Note</u>: there is no need to call this method, as it should be handled only by
     * {@link MS_ObjectWrapperHelper#getWrappedObject(MS_ObjectWrapper, Object)} inside wrapper itself.
