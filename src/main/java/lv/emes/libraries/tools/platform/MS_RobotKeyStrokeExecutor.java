...
/**
 * This implementation ses java.awt.Robot
 ...
 * @version 1.0.
 */
public class MS_RobotKeyStrokeExecutor implements MS_KeyStrokeExecutor {

    //PUBLIC STRUCTURES, EXCEPTIONS, PROPERTIES AND CONSTANTS

    //PRIVATE VARIABLES
    private static MS_RobotKeyStrokeExecutor INSTANCE = null;
    private Robot robot;
     ...
     */
    public MS_RobotKeyStrokeExecutor() throws AWTException {
        robot = new Robot();
    }
     ...
     */
    public static MS_RobotKeyStrokeExecutor getInstance() {
        if (INSTANCE == null)
            try {
                INSTANCE = new MS_RobotKeyStrokeExecutor();
