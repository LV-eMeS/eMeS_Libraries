...
public class ScriptParsingError extends Exception {
    ...
    public final static String ERROR_PARAMETER_COUNT = "Wrong count of passed parameters. Expecting at least: %d";
    ...
    public final static String ERROR_FAILED_TO_SWITCH_MONITOR = "Failed to switch monitor on or off due to invalid syntax. " +
            "Correct syntax is: 'monitor#on#' or 'monitor#off#'";
    public final static String ERROR_WRONG_NUMBER_INPUT = "Failed to set number with value '%s' as parameter to command";
