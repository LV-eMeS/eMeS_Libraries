...
//		MS_FileSystemTools.executeApplication("pom.xml", ""); //file in project root folder
//		MS_FileSystemTools.executeApplication("src/main/resources/test/test.bat", ""); //file in project's deeper folder
		MS_FileSystemTools.executeApplication("src/main/resources/test/test.bat", "Everything works now!"); //file with arguments in project's deeper folder
//		MS_FileSystemTools.executeApplication("src/main/java/lv/emes/libraries/file_system/MS_FileSystemTools.executeApplication capabilities.xls", ""); //file with arguments in project's deeper folder (ALWAYS FAILING)
