 ...
 */
@FunctionalInterface
public interface IFuncOnIncomingCommandFromClientNoData extends MS_ActionOnIncomingTcpIpCommand {

    void handleCommand(MS_TcpIPServer server, MS_ClientOfServer client);
}