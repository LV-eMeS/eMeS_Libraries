 ...
 * <p>IFuncOnIncomingCommandFromClientBinaryData handler = (server, client, dataArr) -&gt; {methods};
 ...
 */
@FunctionalInterface
public interface IFuncOnIncomingCommandFromClientJsonArrayData extends MS_ActionOnIncomingTcpIpCommand {

    void handleCommand(MS_TcpIPServer server, MS_ClientOfServer client, MS_JSONArray data);
}