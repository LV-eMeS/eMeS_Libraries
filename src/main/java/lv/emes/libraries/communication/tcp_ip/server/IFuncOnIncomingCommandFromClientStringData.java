 ...
 * <p>IFuncOnIncomingCommandFromClientBinaryData handler = (server, client, dataStr) -&gt; {methods};
 ...
 */
@FunctionalInterface
public interface IFuncOnIncomingCommandFromClientStringData extends MS_ActionOnIncomingTcpIpCommand {

    void handleCommand(MS_TcpIPServer server, MS_ClientOfServer client, String data);
}