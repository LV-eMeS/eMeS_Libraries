 ...
 * <p>IFuncOnIncomingCommandFromClientBinaryData handler = (server, client, dataObj) -&gt; {methods};
 ...
 */
@FunctionalInterface
public interface IFuncOnIncomingCommandFromClientJsonObjectData extends MS_ActionOnIncomingTcpIpCommand {

    void handleCommand(MS_TcpIPServer server, MS_ClientOfServer client, MS_JSONObject data);
}