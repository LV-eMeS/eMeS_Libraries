 ...
 * <p>IFuncOnIncomingCommandFromServerBinaryData handler = (client, binaryData) -&gt; {methods};
 ...
 */
@FunctionalInterface
public interface IFuncOnIncomingCommandFromServerBinaryData extends MS_ActionOnIncomingTcpIpCommand {

    void handleCommand(MS_TcpIPClient client, byte[] data);
}